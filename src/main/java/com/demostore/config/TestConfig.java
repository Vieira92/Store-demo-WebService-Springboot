...
import com.demostore.entity.Payment;
...
import com.demostore.repository.OrderItemRepository;
import com.demostore.repository.OrderRepository;
import com.demostore.repository.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2020-07-20T21:53:07Z"), o1);
		o1.setPayment(pay1);
